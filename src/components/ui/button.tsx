  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        farmer: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_8px_30px_-8px_hsl(140_30%_15%_/_0.15)] min-h-[56px] text-lg",
        harvest: "bg-gradient-to-r from-amber-500 to-orange-500 text-slate-900 hover:opacity-90 shadow-[0_8px_30px_-8px_hsl(140_30%_15%_/_0.15)] min-h-[56px] text-lg",
        weather: "bg-gradient-to-r from-sky-500 to-blue-400 text-white hover:opacity-90 shadow-[0_4px_20px_-4px_hsl(140_30%_15%_/_0.1)]",
